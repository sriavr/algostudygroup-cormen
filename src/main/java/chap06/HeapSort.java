...
//maxHeapify is a recurive function
//maxHeapify is an iterative function.
...
public class HeapSort {
    ...
    void maxHeapifyItr(int A[],int n, int i)
    {
        while (i < n){
  ...
  //Converting array A to Max-Heap
    ...
    {   
        ...
        for (int i=n-1; i>=0; i--)
        {
          ...
          System.out.println("HeapSorting: " + Arrays.toString(arr));
          //maxHeapify(arr, i, 0);
          maxHeapifyItr(arr, i, 0);
        }      
    }
